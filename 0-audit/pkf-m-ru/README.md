...
- <a href="#user-content-comm">Коммерческие факторы</a>
  ...
  - <a href="#user-content-comm-cat">Коммерческие факторы для категории товаров</a>
- Юзабилити
- Текстовые факторы
- Анализ конукурентов
- Внешние факторы
...
### <a id="user-content-comm-cat"></a>Коммерческие факторы для категории товаров
- Фильтры по различным параметрам **Да,**
- Сортировка выдачи (по уменьшению и увеличению цены, рейтингу, популярности и т.п.) **Да,**
- Индикатор наличия товаров **Нет,**
- Возможность добавить товары к сравнению **Нет,**
- Общее описание категории товара **Нет,**
- Товарная матрица **Нет,**
- Информация о пунктах выдачи **Нет,**
- Информация о доставке **Нет,**
- Информация об оплате **Нет,**
- Отзывы **Нет,**
- Вопросы и ответы **Нет,**
- Пагинация **Нет,**
- Рекомендации по выбору **Нет,**
